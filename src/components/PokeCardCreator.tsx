...
//                 <option value="colorless">EmojiWasHere Colorless</option>
//                 <option value="fire">EmojiWasHere Fire</option>
//                 <option value="water">EmojiWasHere Water</option>
//                 <option value="grass">EmojiWasHere Grass</option>
//                 <option value="lightning">EmojiWasHere Lightning</option>
//                 <option value="psychic">EmojiWasHere Psychic</option>
//                 <option value="fighting">EmojiWasHere Fighting</option>
//               </select>
//             </div>
//           </div>
//           <div>
...
//                 EmojiWasHere EmojiWasHere
//               </option>
//               <option value="3" className="">
//                 EmojiWasHere EmojiWasHere EmojiWasHere
//               </option>
//             </select>
//           </div>
